...
public:
  ...
  double vx, vy, vz;
	...
	//// vector field defined on the vertex
	//icVector2 vec;
  double s;
  int index;
...
public:
  ...
  Triangle *other_triangle(Edge *, Triangle *);
	...
	void normalized_domain(); // normalize the domain to between [0,1]x[0,1]
...
//#define POROUSDATA   // to load the porous media flow data
